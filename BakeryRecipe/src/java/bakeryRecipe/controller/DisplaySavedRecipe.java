 ...
 * @author thongnt
 */
@WebServlet(name = "DisplaySavedRecipe", urlPatterns = {"/DisplaySavedRecipeController"})
...
//    private final String SEARCH_RESULT_PAGE = "search.jsp";
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        // Mapping url         
        String url = siteMaps.getProperty(AppContants.GetSavedRecipe.SAVED_RECIPE_PAGE);
        ...
        try {
           // get userID from Session scope
            ...
            recipeDao.loadSavedRecipes(userId);
